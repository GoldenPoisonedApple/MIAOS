...
# Offline / Online LiRA の再現用アーティファクトを保存
def save_lira_artifacts(
    model_save_dir: str,
    ...
    Returns:
            保存先ディレクトリのパス
    """
    artifacts_dir = os.path.join(model_save_dir, "lira_artifacts")
    ...
    logger.info(f"Saved LiRA artifacts to: {artifacts_dir}")
